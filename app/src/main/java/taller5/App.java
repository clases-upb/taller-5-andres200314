...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
//            System.out.println(hallar_numero());
//            System.out.println(simular_ventas());
//            System.out.println(Calcular_empaque(638));

            // numero jugadores
//            Scanner input = new Scanner(System.in);
//            byte numero_jugadores = input.nextByte();
//            System.out.println(juego_cartas(numero_jugadores));
